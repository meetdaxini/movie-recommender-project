...
resource "google_sql_database_instance" "instance" {
  ...
  deletion_protection = true # Set it to false to delete on terraform destroy
}
...
resource "google_storage_bucket" "media" {
  ...
  location = "US"
  # force_destroy = true # Uncomment to delete storage bucket on terraform destroy
}
...
# Expand Service Account permissions
